        ...
        <div>
            <form method="post" action="settings#server-info-settings">
                <div id="server-info-settings">
                    ...
                    <div class="mb-6">
                        <label for="server_img" class="block text-sm font-medium text-gray-400 mb-2">Image du statut de serveur:</label>
                        <input type="text" class="form-input mt-1 block w-full rounded-lg border-gray-600 bg-gray-700 text-gray-200 p-2 focus:ring-indigo-500 focus:border-indigo-500" id="server_img" name="server_img" value="<?php echo $row['server_img']; ?>">
                    </div>
                </div>
