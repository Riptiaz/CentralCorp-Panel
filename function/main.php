<div class="container mx-auto mt-10 p-6 bg-gray-900 text-white border border-gray-700 rounded-lg shadow-lg">
    <div class="grid grid-cols-1 gap-6">
        <div>
            <form method="post" action="settings.php#general-settings">
                ...
                <div class="mt-6">
                    ...
                    <div class="flex items-center">
                        <input type="checkbox" class="form-checkbox h-5 w-5 text-indigo-600 rounded focus:ring-indigo-500" id="email_verified" name="email_verified" <?php if ($row['email_verified'] == 1) echo 'checked'; ?>>
                ...
                <div class="mb-6 mt-6">
                    ...
                    <div class="mb-6">
                        <label for="ram_min" class="block text-sm font-medium text-gray-400 mb-2">RAM Minimum par défaut (MB) :</label>
                        <input type="number" class="form-input mt-1 block w-full rounded-lg border-gray-600 bg-gray-700 text-gray-200 p-2 focus:ring-indigo-500 focus:border-indigo-500" id="ram_min" name="ram_min" value="<?php echo $row['ram_min']; ?>">
                    </div>
                    <div class="mb-6">
